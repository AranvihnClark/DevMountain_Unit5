...
public class MissingNumber {
    public static void main(String[] args) {
        ...
        System.out.println(locateMissingNumber(array, array.length + 1));
        System.out.println(locateMissingNumber(array2, array2.length + 1));
    }
    ...
    public static int locateMissingNumber(int[] arr, int maxNum) {
